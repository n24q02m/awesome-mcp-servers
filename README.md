...
- [n24q02m/wet-mcp](https://github.com/n24q02m/wet-mcp) [glama](https://glama.ai/mcp/servers/@n24q02m/wet-mcp) 🐍 🏠 ☁️ 🍎 🪟 🐧 - Web search (embedded SearXNG), content extraction (HTML + PDF/DOCX/PPTX via markitdown), and library docs indexing with hybrid search. Built-in Qwen3 embedding, no API keys required.
...
- [n24q02m/better-notion-mcp](https://github.com/n24q02m/better-notion-mcp) [glama](https://glama.ai/mcp/servers/@n24q02m/better-notion-mcp) 📇 ☁️ 🍎 🪟 🐧 - Markdown-first Notion MCP server with 9 composite tools and 39 actions. Dual-mode: local (stdio) or hosted OAuth 2.1 (zero-config URL). ~77% token reduction via tiered docs.
